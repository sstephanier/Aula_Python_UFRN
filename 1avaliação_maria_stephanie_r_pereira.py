# -*- coding: utf-8 -*-
"""1Avaliação-Maria Stephanie R Pereira.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mCLfwby-aSeodp74E9dxbtO02F8gZGLJ
...
Faça um algoritmo em Python que implementa uma calculadora básica com as quatro operações, mais três operações especiais da sua escolha. O usuário do programa sempre que usar deve informar qual operação deseja realizar. [2,5]





Faça um programa em Python que calcula a comissão de um vendedor de imóveis. Cada imóvel tem um percentual diferente que pode ser aplicado ao cálculo da  comissão. [2,5]





Faça um algoritmo em Python que oferece um desconto de 13% para idosos que compram carros. O valor do carro com o desconto deve ser exibido na tela sempre que o idoso consultar. [2,5]





Faça um algoritmo em Python que leia cinco valores, depois informa na tela qual deles é o maior, qual deles é o menor ou se são iguais. [10] - Desafio.
"""
